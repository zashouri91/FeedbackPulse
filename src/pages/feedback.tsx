    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="p-6 text-center">
          <h1 className="text-2xl font-bold text-destructive mb-2">Invalid Survey Link</h1>
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="p-8 text-center">
          ...
          <p className="text-muted-foreground">Your feedback has been successfully recorded.</p>
        </Card>
      </div>
    );
  }
